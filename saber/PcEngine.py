...
class PortfolioConstructor:
    def __init__(self,mtw):
        self.mtw = mtw                  #mt5 wrapper to access metatrader5 functions
        self.mtd = mtd.data(mtw)                                     #accessor for metatrader5 data
        self.rke = rke.riskMgr()
        self.min_lot_size_map = {}
        self.trade_sized_close = mtd.get_trade_sized_close()
