...
class meta5_wrapper:
    def __init__(self,mt5=MT5,login = 7347694, pw = "1523@Rocket!!", server = "ICMarketsSC-MT5-2"):
        #self.login = login
        #self.pw = pw
        #self.server = server
        self.mt5 = mt5
    ...
    def get_account_value(self):
        ...
        acc_bal = info.balance
        positions = self.mt5.positions_get()
        open_pnl = 0
        for p in positions:
            # profit includes swap+commission depending on broker; it's the best "open PnL" signal you get.
            open_pnl += float(p.profit)
        return open_pnl + acc_bal
